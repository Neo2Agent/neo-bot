...
import type { TurnCompleteRequest, TurnHeartbeatRequest } from "@neo-bot/contracts";
...
const pendingLoopStarts = new Map<
  string,
  { delivery: FollowUpDelivery; text: string; images?: import("@neo-bot/contracts").ImageRef[]; followUpId?: string | null }
>();
