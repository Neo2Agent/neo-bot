...
import { nextHistoryIndex, termKeyAction, termKeyBytes } from "@neo-bot/ui/term";
import {
  applyTermChunk,
  createTermScreen,
  type TermScreen,
} from "@neo-bot/ui/term-render";
import { createTermWriteQueue } from "@neo-bot/ui/term-write";
import {
  closeWorkspaceTerm,
