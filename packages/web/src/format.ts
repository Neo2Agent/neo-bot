import { isDeskHostedTarget } from "@neo-bot/contracts/desk";
import type { TranscriptTool } from "@neo-bot/contracts/events";
import { isRemoteControlTarget, runDisplayTitle, type ExecutionTarget } from "@neo-bot/contracts/run";
